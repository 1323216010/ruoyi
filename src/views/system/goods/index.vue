<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="卷后价/折后价" prop="priceA">
        <el-input
          v-model="queryParams.priceA"
          placeholder="请输入卷后价/折后价"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="预估单价" prop="priceB">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="卷后价/折后价" prop="priceA">
          <el-input v-model="form.priceA" placeholder="请输入卷后价/折后价" />
        </el-form-item>
        <el-form-item label="预估单价" prop="priceB">
          <el-input v-model="form.priceB" placeholder="请输入预估单价" />
        </el-form-item>
        <el-form-item label="图片(用;号分割？)" prop="pictures">
